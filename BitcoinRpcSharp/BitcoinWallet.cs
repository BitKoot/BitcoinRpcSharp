using BitcoinRpcSharp.Requests;
...
{
    /// <summary>
    /// BitcoinWallet class containing the actual methods to invoke on the Bitcoin wallet.
    /// </summary>
    public class BitcoinWallet : BitcoinWalletBase
    {
        public BitcoinWallet(string rpcUrl, string rpcUser, string rpcPassword, bool logJsonResultToConsole)
            : base(rpcUrl, rpcUser, rpcPassword, logJsonResultToConsole)
        {
        }
